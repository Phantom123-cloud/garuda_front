...
import {
  ...
  PhoneIncoming, ShieldOff, BookOpen, LogOut, History, BookMarked, Shield, Settings, ScrollText,
} from 'lucide-react';

type NavItem = { label: string; href: string; icon: React.ElementType; permission?: string };
...
const nav: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Лог активности',   href: '/admin/activity',  icon: ScrollText,      permission: 'ACTIVITY_VIEW' },
    ],
  },
  {
    section: 'Управление',
