...
export const numbersApi = {
  ...
  resetByAgentResult: (campaignId: number, agentResult: string | null, agentLabel?: string | null) =>
    api.post(`/numbers/campaign/${campaignId}/reset-by-agent-result`, { agentResult, agentLabel }).then(r => r.data),
