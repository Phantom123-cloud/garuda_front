    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex w-[420px] flex-col bg-card border-r border-border p-10 relative overflow-hidden flex-shrink-0">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div>
            <div className="text-base font-semibold text-foreground">Garuda Platform</div>
            <div className="text-xs text-muted-foreground">Admin Controller</div>
          </div>
        </div>
        <div className="mt-auto relative z-10">
          <p className="text-xl font-semibold text-foreground mb-2 leading-snug">
            Управление<br />пространствами
          </p>
          <p className="text-sm text-muted-foreground mb-8">
            Создавайте и управляйте пространствами для ваших клиентов. Контролируйте доступ и подписку.
          </p>
        ...
        <div className="mt-8 relative z-10 text-xs text-muted-foreground/40">Platform v1.0</div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-semibold text-foreground mb-1">Вход для администратора</h1>
            <p className="text-sm text-muted-foreground">Платформенный контроль доступа</p>
          </div>
