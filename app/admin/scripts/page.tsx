                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <textarea value={step.content} onChange={e => updateStep(step._key, { content: e.target.value })}
                      ...
                      rows={3}
                      className="w-full bg-input border border-border rounded-lg px-3 py-2 text-sm text-foreground outline-none focus:ring-2 focus:ring-ring resize-y min-h-[76px] placeholder:text-muted-foreground" />
