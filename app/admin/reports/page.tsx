...
export default function ReportsPage() {
  ...
  const totConnPerH  = totals && totals.dialTime > 0 ? parseFloat((totals.talkTime / totals.dialTime / 24).toFixed(4)) : 0;
  ...
  const totWorkPct   = totals && (totals.dialTime + totals.pauseTime) > 0
    ? parseFloat(((totals.talkTime / (totals.dialTime + totals.pauseTime)) * 100).toFixed(1))
    : 0;
